...
pass_env=(
  PERSEUS_ENABLED PERSEUS_ACTOR_PROVIDER PERSEUS_ACTOR_MODEL PERSEUS_ACTOR_BASE_URL
  PERSEUS_ACTOR_API_TYPE PERSEUS_ACTOR_API_KEY PERSEUS_ACTOR_USER_AGENT PERSEUS_ACTOR_THINKING
  PERSEUS_SPECULATOR_PROVIDER PERSEUS_SPECULATOR_MODEL PERSEUS_SPECULATOR_BASE_URL
  PERSEUS_SPECULATOR_API_TYPE PERSEUS_SPECULATOR_API_KEY PERSEUS_SPECULATOR_USER_AGENT
  PERSEUS_SPECULATOR_THINKING PERSEUS_TOP_K PERSEUS_SPECULATOR_MAX_TOKENS
  PERSEUS_SPECULATOR_TIMEOUT_MS PERSEUS_SPECULATOR_MIN_CONFIDENCE
  PERSEUS_SPECULATOR_MAX_MISS_TURNS PERSEUS_SPECULATOR_COOLDOWN_TURNS
  PERSEUS_SPECULATOR_CONTEXT_MESSAGES
  PERSEUS_DEPTH2 PERSEUS_CANONICAL_TOOL_STATE PERSEUS_DEPTH2_MIN_CONFIDENCE
